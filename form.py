...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.gridLayout.addWidget(self.pushButton_crawler, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_song, 0, 0, 1, 1)
        self.lineEdit_index = QtWidgets.QLineEdit(Widget)
        self.lineEdit_index.setObjectName("lineEdit_index")
        self.gridLayout.addWidget(self.lineEdit_index, 0, 1, 1, 1)
