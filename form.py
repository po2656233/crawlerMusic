...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.lineEdit_singer = QtWidgets.QLineEdit(Widget)
        self.lineEdit_singer.setInputMask("")
        self.lineEdit_singer.setObjectName("lineEdit_singer")
        self.gridLayout.addWidget(self.lineEdit_singer, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_crawler, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Widget):
        ...
        self.lineEdit_singer.setPlaceholderText(_translate("Widget", "搜索歌手"))
